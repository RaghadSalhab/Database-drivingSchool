...
public class instructorHome implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            try (PreparedStatement countEnrollmentsByInstructorStatement = DB.con.prepareStatement(countEnrollmentsByInstructorQuery)) {
            ...
            try (PreparedStatement countAllEnrollmentsStatement = DB.con.prepareStatement(countAllEnrollmentsQuery)) {
        ...
        try {
            ...
            try (PreparedStatement countUniqueCoursesStatement = DB.con.prepareStatement(countUniqueCoursesQuery)) {
