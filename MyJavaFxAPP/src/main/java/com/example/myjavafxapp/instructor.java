...
import com.example.myjavafxapp.DB;
...
public class instructor extends home implements Initializable {
        ...
        try {
          ...
          /*  else if(date.getPromptText().equals(null))
                ...
                try {
                    ...
                    String viewInstructor = "INSERT INTO driving_school.instructor (issn, fname, mname, lname, phonenumber, salary, licensenumber, gender, birthdate) VALUES ('"
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Image newImage = new Image(getClass().getResource("teacher.png").toExternalForm());
    ...
    private void showData() {
        try {
            ...
            op.clear();
            String viewInstructor = "select issn,fname,mname,lname,phonenumber,salary,licensenumber,gender,birthdate ,email,password from driving_school.instructor order by salary";
            Statement st = DB.con.createStatement();
