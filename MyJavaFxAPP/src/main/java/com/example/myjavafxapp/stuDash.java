...
public class stuDash implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(qEnrolcount);
        ...
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(qEnroll);
            pst.setString(1, userInfo.ssn);
            ResultSet re = pst.executeQuery();
    ...
    double Payamount(int x)
    {
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(q);
            pst.setInt(1, x);
            ResultSet re = pst.executeQuery();
            if(re.next())
