...
public class Forgetpassword implements Initializable{
    ...
    public int isEmailAndSSNExist(String email, String ssn) {
        ...
        String searchQueryStudent = "SELECT * FROM driving_school.student WHERE email = ? AND ssn = ?";

        try (PreparedStatement preparedStatementInstructor = DB.con.prepareStatement(searchQueryInstructor)) {
        ...
        try (PreparedStatement preparedStatementAdmin = DB.con.prepareStatement(searchQueryAdmin)) {
        ...
        try (PreparedStatement preparedStatementStudent = DB.con.prepareStatement(searchQueryStudent)) {
    ...
    public void updateInstructorPassword(String ssn, String newPassword) {
        ...
        try (PreparedStatement preparedStatement = DB.con.prepareStatement(updateQuery)) {
    ...
    public void updateStudentPassword(String ssn, String newPassword) {
        String updateQuery = "UPDATE driving_school.student SET password = ? WHERE ssn = ?";
