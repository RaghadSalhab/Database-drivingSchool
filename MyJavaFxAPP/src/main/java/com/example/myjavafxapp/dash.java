...
public class dash extends home implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        home.st_lab.setText("Home Dash Board");
        Image newImage = new Image(getClass().getResource("dashboard.png").toExternalForm());
        home.getStaticLogoImageView().setImage(newImage);
        try {


            String stuConut = "Select count(ssn) from driving_school.student ";
