...
import static com.example.myjavafxapp.instructorMyStudent.selectedRowMystudentEnrollmentId;
...
public class instructorMyStudentShowLesson implements Initializable {
    ...
    public void deletea(javafx.event.ActionEvent actionEvent) {
        ...
        try (PreparedStatement preparedStatement = DB.con.prepareStatement(deleteQuery)) {
...
showData();
    ...
    private boolean lessonExists(LocalDate lessonDate, String lessonTime) {
        ...
        try (PreparedStatement preparedStatement = DB.con.prepareStatement(checkQuery)) {
            // Convert LocalDate to java.util.Date
    ...
    private void showData() {
        ...
        try {
            ...
            try (PreparedStatement preparedStatement = DB.con.prepareStatement(viewDataQuery)) {
