...
public class studLesson implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        img.setImage(new Image(getClass().getResource("enrollment (3).png").toExternalForm()));
    ...
    void showenroll() {
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(qid);
    ...
    void Viewlesson(ActionEvent event) throws IOException {
        ...
        if(selectedRow>=0) {
            ...
            img.setImage(new Image(getClass().getResource("lesson (1).png").toExternalForm()));
    ...
    private void showLesson() {
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(viewLessons);
    ...
    void ViewPayments(ActionEvent event) throws IOException {
        ...
        if(selectedRow>=0) {
            ...
            img.setImage(new Image(getClass().getResource("payment-method.png").toExternalForm()));
            ...
            try {
                ...
                java.sql.PreparedStatement pst = DB.con.prepareStatement(q2);
                pst.setInt(1, enrollidLes);
    ...
    void showPay()
    {
        ...
        try {
            ...
            java.sql.PreparedStatement pst = DB.con.prepareStatement(viewPay);
            pst.setInt(1, enrollidLes);
